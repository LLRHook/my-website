// Shared inline SVG icons (FEAT-1781502128). Markup preserved from the original
// inline definitions so the rendered DOM is unchanged.

import type { SocialIcon } from "@/app/lib/constants";
