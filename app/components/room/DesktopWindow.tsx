...
function Interests() {
  return <section><p className="eyebrow">A FEW THINGS AROUND THE ROOM</p><h2>Off the clock<span>.</span></h2><p className="app-lead">There&apos;s usually another problem to solve. Some of them involve climbing shoes.</p><div className="interest-list">
    ...
    <article><span className="interest-illustration wings-mark">BW<span>WINGS</span></span><div><span className="interest-number">04 / RECHARGE</span><h3>Wings after a long week.</h3><p>A small nod to Buffalo Wild Wings. Good food belongs in the room, too.</p></div></article>
