...
function Interests() {
  return <section><p className="eyebrow">A FEW THINGS AROUND THE ROOM</p><h2>Off the clock<span>.</span></h2><p className="app-lead">There&apos;s usually another problem to solve. Some of them involve climbing shoes.</p><div className="interest-list"><article><span className="interest-illustration climbing-mark">⌁</span><div><span className="interest-number">01 / MOVE</span><h3>One more attempt.</h3><p>Rock climbing is my regular break from the screen. Different holds, the same satisfaction of working through a problem.</p></div></article><article><span className="interest-illustration mana-mark"><i /><i /><i /><i /><i /></span><div><span className="interest-number">02 / PLAY</span><h3>A little tabletop strategy.</h3><p>Magic: The Gathering decks and a few Pokémon favorites have a place on the shelf. There&apos;s always room for a good game.</p></div></article><article><span className="interest-illustration wings-mark">BW<span>WINGS</span></span><div><span className="interest-number">03 / RECHARGE</span><h3>Wings after a long week.</h3><p>A small nod to Buffalo Wild Wings. Good food belongs in the room, too.</p></div></article><article><span className="interest-illustration"><Icon name="code" /></span><div><span className="interest-number">04 / TINKER</span><h3>Probably building a tool for that.</h3><p>Agentic workflows, deployment automation, and little utilities that make the next development cycle easier.</p></div></article></div></section>;
}
